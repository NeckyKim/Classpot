...
import GenerateShortApplicantCode from '../../utils/GenerateShortApplicantCode';
...
export default function AddApplicant({
  userCode,
  testCode,
  setIsAddingApplicant,
}: {
  userCode: string | undefined;
  testCode: string | undefined;
  setIsAddingApplicant: any;
}) {
  ...
  return (
    <Modal title="응시자 추가" onClose={() => setIsAddingApplicant(false)}>
      ...
      <Buttons>
        <SubmitButton text="추가" onClick={addApplicant} disabled={applicantName.replace(/(\s*)/g, '') === ''} />
