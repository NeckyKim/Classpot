...
export default function ChattingContainer({ applicantName, chatting, setShowChatting, chattingText, setChattingText, sendChatting }: { applicantName: string, chatting: any, setShowChatting: any, chattingText: string, setChattingText: any, sendChatting: any }) {
            ...
            <div className={styles.chattingListContainer} ref={chattingRef}>
                {
                    chatting?.length > 0
                            ...
                            <div>
                                {
                                    ...
                                    <div className={elem.sender === "manager" ? styles.senderManager : styles.senderApplicant}>
                                        <div className={styles.senderName}>
                                            {elem.sender === "manager" ? "관리자" : applicantName}
                                        </div>
                        ...
                        <div className={styles.chattingEmpty}>
                            채팅 기록이 없습니다.
                        </div>
                }
            </div>
