  ...
  return (
    <div>
      <div className={styles.comment}>
        ...
        <br />
        시작하기 전에 <span style={{ fontWeight: '700', color: 'rgb(0, 100, 250)' }}>시험 기본 정보</span>를
        확인해주세요.
      </div>

      <div className={styles.header}>기본 정보</div>
      ...
      <div className={styles.infoContainer}>
        ...
        >
          <div className={styles.infoLabel}>시험 이름</div>

          <div className={styles.infoValue}>{testInfo.testName}</div>
        </div>
        ...
        >
          <div className={styles.infoLabel}>관리자</div>

          <div className={styles.infoValue}>{testInfo.managerName}</div>
        </div>
        ...
        >
          <div className={styles.infoLabel}>응시자</div>

          <div className={styles.infoValue}>{applicantInfo?.applicantName}</div>
        </div>
      </div>

      <div className={styles.header}>시험 진행 기간</div>

      <div className={styles.infoContainer}>
        <div className={styles.infoElements}>
          <div className={styles.infoLabel}>시험 시작 일시</div>
        ...
        <div className={styles.infoElements}>
          <div className={styles.infoLabel}>시험 종료 일시</div>
      ...
      {testInfo.preview && (
        <>
          <div className={styles.header}>문항 구성</div>
