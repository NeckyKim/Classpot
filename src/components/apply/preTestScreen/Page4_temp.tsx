...
export default function Page4({ setPage, checks, setChecks }: any) {
  ...
  return (
    <div>
      ...
      <SubmitButton text="공유하기" onClick={shareScreen} />

      <ol className={styles.alertContainer}>
        <div>화면 공유 방법</div>

        <li>[공유하기] 버튼을 클릭합니다.</li>

        <li>상단의 [전체 화면] 탭을 클릭합니다.</li>

        <li>공유할 화면을 클릭 후, 하단의 [공유] 버튼을 클릭합니다.</li>
      </ol>

      <div className={styles.infoContainer}>
        [전체 화면] 공유가 아닌 [Chrome 탭] 또는 [창] 공유를 하여 특정 화면만 공유할 경우 부정행위로 간주되어 불이익을
        받을 수 있습니다.
      </div>
