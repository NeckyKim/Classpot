                ...
                (isTestTime[0] === "전" || isTestTime[0] === "중")
                    ...
                    <div className={styles.container}>
                        <div className={styles.containerTop}>
                            ...
                            >
                                <div className={tab === 4 ? styles.tabNumberSelected : styles.tabNumberNotSelected }>
                                    4
                                </div>
...

                        {
                            ...
                            <div className={styles.containerBottom}>
                                <div className={styles.intro}>
                                    해당 시험은 <span className={styles.introHighlight}>본인 확인</span>을 진행하지 않습니다.
                                </div>
                                ...
                                <div
                                    className={true ? styles.nextButtonAbled : styles.nextButtonDisabled}
                                    onClick={() => {
                                        if (true) {
                                            setTab(4);
                                        }
