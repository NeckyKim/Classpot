...
export default function QuestionContainer({ questionObject, index, answerSheet, score, showAnswer }: { questionObject: any, index: number, answerSheet: any, score: any, showAnswer: boolean }) {
    return (
